...
namespace StringToDataRowConverterTest
{
    ...
    void data_row_has_default_values(kuka_generator::DataRow& data_row)
    {
        ...
        Assert::AreEqual(0.0f, data_row.position.x);
        Assert::AreEqual(0.0f, data_row.position.y);
        Assert::AreEqual(0.0f, data_row.position.z);

        Assert::AreEqual(0.0f, data_row.position_filtered.x);
        Assert::AreEqual(0.0f, data_row.position_filtered.y);
        Assert::AreEqual(0.0f, data_row.position_filtered.z);

        Assert::AreEqual(1.0f, data_row.orientation.data[0]);
        Assert::AreEqual(0.0f, data_row.orientation.data[1]);
        Assert::AreEqual(0.0f, data_row.orientation.data[2]);

        Assert::AreEqual(0.0f, data_row.orientation.data[3]);
        Assert::AreEqual(1.0f, data_row.orientation.data[4]);
        Assert::AreEqual(0.0f, data_row.orientation.data[5]);

        Assert::AreEqual(0.0f, data_row.orientation.data[6]);
        Assert::AreEqual(0.0f, data_row.orientation.data[7]);
        Assert::AreEqual(1.0f, data_row.orientation.data[8]);

        Assert::AreEqual(1.0f, data_row.orientation_filtered.data[0]);
        Assert::AreEqual(0.0f, data_row.orientation_filtered.data[1]);
        Assert::AreEqual(0.0f, data_row.orientation_filtered.data[2]);

        Assert::AreEqual(0.0f, data_row.orientation_filtered.data[3]);
        Assert::AreEqual(1.0f, data_row.orientation_filtered.data[4]);
        Assert::AreEqual(0.0f, data_row.orientation_filtered.data[5]);

        Assert::AreEqual(0.0f, data_row.orientation_filtered.data[6]);
        Assert::AreEqual(0.0f, data_row.orientation_filtered.data[7]);
        Assert::AreEqual(1.0f, data_row.orientation_filtered.data[8]);

        Assert::AreEqual(0.0, data_row.velocity);

        Assert::IsTrue(data_row.alive);

        Assert::AreEqual(0.0f, data_row.euler_angles.x);
        Assert::AreEqual(0.0f, data_row.euler_angles.y);
        Assert::AreEqual(0.0f, data_row.euler_angles.z);
    }
